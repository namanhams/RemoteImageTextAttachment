...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Pham Hoang Le" => "email@address.com" }
  # Or just: spec.author    = "Pham Hoang Le"
  # spec.authors            = { "Pham Hoang Le" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/Pham Hoang Le"
  ...
  spec.source       = { :git => "https://github.com/namanhams/RemoteImageTextAttachment.git", :commit => "9b431f0af26463161240a428f29f12dbd97f5945" }
